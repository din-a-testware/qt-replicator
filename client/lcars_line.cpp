...
LCARS_Line::LCARS_Line(QWidget *parent) :
QWidget(parent) {
...
Qt::Alignment LCARS_Line::getAlignment(int alignnumber) {
...
void LCARS_Line::paintEvent(QPaintEvent*) {
...
QVector<QRect> LCARS_Line::getRect(QRect rect_topLeftEdge, QRect rect_bottomLeftEdge, int edge) {
...
int LCARS_Line::getBigger(int x, int y) {
    int checkval = x-y;
